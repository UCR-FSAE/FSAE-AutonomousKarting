...
namespace local_planning
{
    class LocalPlannerManagerNode : public nav2_util::LifecycleNode
    {
        ...
        using GoalHandleTrajectoryGeneration =
            rclcpp_action::ClientGoalHandle<TrajectoryGeneration>;
    ...
    protected:
        ...
        rclcpp_action::Client<TrajectoryGeneration>::SharedPtr
            trajectory_generator_client;
        void trajectory_generator_goal_response_callback(
        ...
        void trajectory_generator_result_callback(
        ...
        /* Trajectory Picker */
        std::shared_ptr<local_planning::TrajectoryPickerROS>
            trajectory_picker_node_;
        std::unique_ptr<nav2_util::NodeThread> trajectory_picker_thread_;
        void on_best_trajectory_publication_received(
            const planning_interfaces::msg::Trajectory::SharedPtr msg);
        rclcpp::Subscription<planning_interfaces::msg::Trajectory>::SharedPtr
            best_trajectory_subscriber_;
        std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<
            planning_interfaces::msg::Trajectory>>
            possible_trajectory_publisher_;
